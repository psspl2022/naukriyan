        ...
        <div class="col-11">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Consultant Job</h3>
                    ...
                    >
                      ...
                      <tbody>
                        <tr v-for="(data, index) in alldata" :key="data.id">
                          <td>{{ index + 1 }}</td>
                          <td>
                            <router-link :to="`/assign-job/${data.id}`"><i
                          ...
                          <td>{{ data.title }}</td>
                          <td>{{ data.job_role }}</td>
                          <td>{{ data.job_vaccancy }}</td>
                          <td>{{ data.job_exp }}</td>
                          <td>{{ data.job_address }}</td>
                          <td>{{ data.job_skills }}</td>
                        </tr>
                      </tbody>
                    </table>
...
export default {
  ...
  mounted() {
    this.$store.dispatch("getAllData", "/jobsconsultant");
