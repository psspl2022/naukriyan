                ...
                <div class="col-md-11">
                    ...
                    <div class="card card-primary">
                        <div class="card-header gr">
                            <h3 class="card-title">Edit Consultant</h3>
                        </div>  {{editData}} 
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form role="form" @submit.prevent="updateConsultant()" enctype="multipart/form-data">
                            <div class="card-body">
                                  ...
                                  <div class="form-group col-md-4 mb-3">
                                      <label for="user_password">Password</label>
                                        <div class="input-group">
                                          <input :type="passwordFieldType" name="password" id="password" class="form-control" data-toggle="password" v-model="password"  :class="{ 'is-invalid': form.errors.has('password') }">
                                ...
                                <div class="form-group col-md-4 mb-3">
                                    ...
                                    <select class="form-control" :class="{ 'is-invalid': form.errors.has('use_recruitment_service') }" v-model="form.use_recruitment_service">
                                        <option disabled value="">Select One</option>
                                  ...
                                  <input type="file"  class="form-control" name="profile_pic_thumb"  @change="changePhoto($event)">
...
<script>
    export default {
        ...
        mounted(){
          ...
          this.$store.dispatch('getEditData',`/edit-consultant/${this.$route.params.consultantid}`)
        ...
        methods:{
          switchVisibility() {
            ...
            updateConsultant(){
                this.form.post(`/update-consultant/${this.$route.params.consultantid}`)
                    .then((response)=>{
            ...
            updateImage(){
                ...
                if(img.length>100){
                    ...
                    return `consultant_profile_image/${this.form.profile_pic_thumb}`
                }
