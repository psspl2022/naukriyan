      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card">
                ...
                <div class="col-md-2">
                  ...
                  <div class="form-group">
                    <select name="industry_id" class="form-control" v-model="industry_id">
                      ...
                      <option v-for='data in industries' :value='data.id' :key="data.id">{{
                          data.category_name
                        }}
                      </option>
                    </select>
            ...
            <!-- /.card-header -->
            <div class="card-body">
              <b>Showing :</b> <span>{{ resultInfo.from ? resultInfo.from:0 }} – {{ resultInfo.to ? resultInfo.to:0 }} of
...
export default {
  ...
  methods: {
    ...
    getFilterData: function (page = 1) {
      let self = this;
      axios.get('jobseeker-filter?industry_id=' + this.industry_id + '&email=' + this.email + '&status=' + this.status + '&from_date='+this.from_date +'&to_date=' + this.to_date +'&page=' + page).then(function (response) {
