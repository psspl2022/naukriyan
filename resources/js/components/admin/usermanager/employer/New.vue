         ...
         <div class="col-sm-12">
          <ol class="breadcrumb float-sm-left">
              <button class="btn btn-primary">
                <router-link to="/employer-list" style="color:#fff">Employer List</router-link>
              </button>
            </ol>
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        <div class="card-header gr">
                            <h3 class="card-title">Add New Employer</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->

                        <form role="form" @submit.prevent="addemployer()" enctype="multipart/form-data">
                            <div class="card-body">
                              <div class="form-row">
          ...
          switchVisibility() {
            ...
            updateImage(){
                ...
                if(img.length>100){
                    ...
                    return `emp_profile_image/no-preview-available.png`
                }
