...
<script>
    export default {
        ...
        metaInfo: {
            ...
            meta:[
                {name: 'keywords', content: 'Placement agencies in Delhi, Best job portals in India'},
            {name: 'description', content: 'Thanks To modern technology and online job portals, searching for a job is as easy as one click of your mouse. Here is the list of the best job website used in India'}
            ],
        },
        mounted() {
            this.getFaqsData()
