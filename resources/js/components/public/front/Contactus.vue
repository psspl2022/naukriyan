...
export default {
  ...
  metaInfo: {
    ...
    meta: [
      { name: "keywords", content: "Best recruitment agencies in Delhi" },
      {
        name: "description",
        content:
          "TBest recruitment Placement agencies in Delhi- Apply for jobs IT and Non-IT jobs through the best Placement consultant agencies in Delhi. Call Us ☎ (+91) 117-962-6411",
      },
    ],
  },
  mounted() {
