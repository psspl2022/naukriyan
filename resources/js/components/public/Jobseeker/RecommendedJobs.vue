<template>
  <div id="recommended-jobs">
            ...
            <div class="row">
              <div class="col-xs-12 col-sm-8">
                <ol class="breadcrumb">
                  ...
                  <li class="active">Recommended Jobs</li>
                </ol>
              </div>
    ...
    <section class="top-adjust section pb-5 pt-0">
      <div class="container">
        <div class="row">
          <div class="col-sm-12">
            <div class="card">
              <div class="card-body">
                <div class="interview">
                  <h2 class="interview">Recommended Jobs</h2>
                </div>
                <div class="table-responsive">
                  <table class="table table-hover custom-table">
                    ...
                    <tbody>
                      <tr
                        v-for="(recommendedJob, index) in recommendedJobs"
                        :key="recommendedJob.id"
                      >
                        <td>{{ index + 1 }}</td>
                        <td>{{ recommendedJob.title }}</td>
                        <td>{{ recommendedJob.job_role }}</td>
                        <td>
                          {{
                        ...
                        <td>
                          <router-link
                            :to="`/edit-viewjobs/${recommendedJob.id}`"
...
export default {
  ...
  methods: {
    getRecommendedJobs() {
      axios.get("/recommended-job").then((response) => {
        this.recommendedJobs = response.data.data;
      });
    },
  },
};
