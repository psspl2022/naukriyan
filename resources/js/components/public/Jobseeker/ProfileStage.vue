                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="cms-pg-header">
                            <h2 class="hk-pg-title">Profile Details</h2>
                        </div>
                    </div>
                </div>
                <div class="card mt-3">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-12">
                                <i class="fa fa-info" aria-hidden="true"></i><span style="color: red">
                                    Name,Email,Contact No</span>
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-sm-4">
                                                ...
                                                <input type="text" class="form-control" name="contact_no"
                                                    placeholder="Enter Full Contact No" v-model="form.contact_no"
                                                ...
                                                <div class="">
                                                    <div class="row">
                                                        <div class="col-sm-6">
                                                            ...
                                                            <select class="form-control" name="main_exp"
                                                                v-model="form.main_exp" :class="{
                                            ...
                                            <div class="col-sm-4">
                                                ...
                                                <select class="form-control custom-select" name="job_industry_id"
                                                    v-model="form.job_industry_id" :class="{
                                            ...
                                            <div class="col-sm-4">
                                                ...
                                                <select class="form-control custom-select" v-model="form.job_exp"  name="preferred_loc">
                                                    <optgroup :label="st.state" v-for="st in location" :key="st">
                                                        <option v-for="(loc, index) in st.location" :key="index"
                                                            :value="loc.location">
                                                            {{ loc.location }}
                                                        </option>
                                                    </optgroup>
...
export default {
    ...
    methods: {
        ...
        setDob(){
            ...
            var selectedDay="day";
            for (var i=1;i <= this.Days[0];i++){ //add option days
        ...
        change_year()
        {
            ...
            if( $("#month").val() == 2)
            {
                ...
                $(day).empty();
                var option = '<option value="day">day</option>';
                for (var i=1;i <= this.Days[1];i++){ //add option days
                        option += '<option value="'+ i + '">' + i + '</option>';
            }
                $(day).append(option);
        ...
        change_month() {
            ...
            for (var i=1;i <= this.Days[ month ];i++){ //add option days
                option += '<option value="'+ i + '">' + i + '</option>';
            }
            $(day).append(option);
            if( val > this.Days[ month ] )
