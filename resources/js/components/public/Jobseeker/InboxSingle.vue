                        ...
                        <div class="mail-box">
                            <aside class="sm-side">
                                <div class="user-head">
                                    <div class="inbox-avatar">
                                        <img v-if="allProfile.profile_pic_thumb" width="64" height="60" :src="'/jobseeker_profile_image/' +allProfile.profile_pic_thumb">
                                ...
                                <ul class="inbox-nav inbox-divider">
                                    <li class="active">
                                        <router-link :to="`/inbox`"><i class="fa fa-inbox"></i> Inbox <span class="label label-danger pull-right" v-if="countUnreadMessage > 0">({{ countUnreadMessage }})</span></router-link>
                                    </li>
                                    <li>
                            ...
                            <aside class="lg-side">
                                <div class="inbox-head">
                                    <span><router-link :to="`/inbox`"><i class="fa fa-arrow-left"></i></router-link></span>
                                </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            sendMessage() {
                this.status = true;
                axios.post('/send-message-to-employer', this.form).then(response => {
