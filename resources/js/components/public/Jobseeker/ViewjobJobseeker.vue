      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-8">
            <div class="card mt-3">
              <div class="card-body">
               <ul class="simple-list-sshare mb-2">
                  <li><a
                      :href="'https://www.facebook.com/sharer/sharer.php?message='+alldata.title+' job in '+alldata.cities_name+' for detail click here&u=https://naukriyan.com/share-job/'+alldata.id+''"
                      target="_blank" rel="noopener" id="t-facebook" title="Facebook"><i class="fab fa-facebook-square"></i></a></li>
                  <li><a
                      :href="'https://www.linkedin.com/sharing/share-offsite/?message='+alldata.title+' job in '+alldata.cities_name+' for detail click here&url=https%3A%2F%2Fwww.naukriyan.com/share-job/'+alldata.id" 
                      target="_blank" rel="noopener" id="t-linkedin" title="Linkedin"><i
                      class="fab fa-linkedin"></i></a></li>
                  <li><a
                      :href="'https://twitter.com/share?text='+alldata.title+' job in '+alldata.cities_name+' for detail click here&url=https://naukriyan.com/share-job/'+alldata.id+''"
                      target="_blank" rel="noopener" id="t-twitter" title="Twitter"><i
                      class="fab fa-twitter-square" ></i></a></li>
                   <li><a
                      :href="'https://api.whatsapp.com/send/?phone&text='+alldata.title+' job in '+alldata.cities_name+' for detail click this link https://naukriyan.com/share-job/'+alldata.id+''"
                      target="_blank" rel="noopener" id="t-whatsapp" title="Whatsapp"><i
                      class="fab fa-whatsapp" ></i></a></li>
                      
                    <li><a
                      :href="'http://pinterest.com/pin/create/button/?url=https://naukriyan.com/share-job/'+alldata.id+'&description='+alldata.title+' Job in '+alldata.cities_name+' .For more details Follow this link. https://naukriyan.com/share-job/'+alldata.id+''"
                      target="_blank" rel="noopener" id="t-pinterest" title="Pinterest"><i
                      class="fab fa-pinterest"></i></a></li>

                       <li><a
                      :href="'http://www.tumblr.com/share/link?url=http://naukriyan.com/share-job/'+alldata.id+'&amp;name='+alldata.title+'&amp;description='+alldata.title+' Job in '+alldata.cities_name+' for more details follow this link https://naukriyan.com/share-job/'+alldata.id+''"
                      target="_blank" rel="noopener" id="t-tumblr" title="Tumblr"><i
                      class="fab fa-tumblr"></i></a></li>

                      <li><a
                      :href="'https://t.me/share/url?url=http://naukriyan.com&text='+alldata.title+' Job in '+alldata.cities_name+' for more details follow this link https://naukriyan.com/share-job/'+alldata.id+''"
                      target="_blank" rel="noopener" id="t-telegram-plane" title="Telegram"><i
                      class="fab fa-telegram-plane"></i></a></li>
                      
                      <li><a
                      :href="'https://reddit.com/submit?url=http://naukriyan.com&title='+alldata.title+' Job in '+alldata.cities_name+' .for more details follow this link https://naukriyan.com/share-job/'+alldata.id+''"
                      target="_blank" rel="noopener" id="t-reddit-alien" title="Reddit"><i
                      class="fab fa-reddit-alien"></i></a></li>
                    

                       <li><a
                      :href="'mailto:?subject='+alldata.title+' Job in '+alldata.cities_name+'&body='+alldata.title+' Job in '+alldata.cities_name+' .for more details follow this link https://naukriyan.com/share-job/'+alldata.id+' '"
                      target="_blank" rel="noopener" id="t-envelope" title="Email"><i
              ...
              <div class="card-body">
                ...
                <ul class="ove-detail-list p-0">
                  <li>
                    ...
                    <span v-else>{{ ' &#8377 ' + (new Intl.NumberFormat('en-IN').format(alldata.offered_sal_min)) }} - {{
                        ' &#8377 ' + (new Intl.NumberFormat('en-IN').format(alldata.offered_sal_max))
                      }}</span>
...
export default {
  ...
  metaInfo: {
      ...
      // meta:[
      //     {name: 'keywords', content: alldata.meta_keywords},
      //     {name: 'description', content: alldata.meta_description}
      // ],
      meta:[
          {name: 'keywords', content: 'alldata.meta_keywords'},
          {name: 'description', content: 'alldata.meta_description'}
