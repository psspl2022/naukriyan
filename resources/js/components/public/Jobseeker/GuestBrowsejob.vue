          ...
          <form>
            <div class="form-group row">
              <div class="col-sm-4 pr-0">
                <input type="text" placeholder="Skills, Designation, Companies" class="form-control"/>
                <i class="fa fa-pencil-alt search-icons" aria-hidden="true"></i>
              </div>
              ...
              <div class="col-sm-2">
                <div class="">
                  <select name="slct" id="slct" class="form-control rounded-0">
                    <option selected disabled>Experince</option>
              ...
              <div class="col-sm-2">
                <div class="">
                  <select name="slct" id="slct" class="form-control rounded-0">
                    ...
                    <option value="0"> 0-1 Lac</option>
                    <option value="1">1 Lac</option>
                    <option value="2">2 Lac</option>
                    <option value="3">3 Lac</option>
                  </select>
                  <i class="fa fa-rupee-sign search-icons" aria-hidden="true"></i>
                </div>
              </div>

              <div class="col-sm-2">
                <button class="btn search-btn"><i class="fa fa-search mr-2" aria-hidden="true"></i>Search</button>
              </div>
            </div>
            <div class="col-sm-12 mt-5">
              <button class="btn transparent"><i class="fa fa-file-invoice mr-2" aria-hidden="true"></i>Upload Your CV
              </button>
            </div>
          </form>
        </div>
                  ...
                  <form action="" method="GET">
                    <div class="gap-10">
                      ...
                      <div class="col-sm-12 text-center">
                        <button type="submit" class="rounded-0 btn btn-block btn-primary btn-icon w-100" v-if="loading">
                          Loading...
                        </button>
                        <button @click.prevent="jobSearchByKeywords()" type="submit"
                                class="rounded-0 btn btn-block btn-primary btn-icon w-100" v-else="">SUBMIT
                        </button>
                      </div>
                    </div>
                  </form>
                      ...
                      <li class="list-item" v-for="industry in alldata" :key="industry.id">
                        <div class="my-checkbox">
                          <label class="checkbox-inline">
                            ...
                            {{ industry.category_name }}<small>({{ industry.jobmanagers.length }})</small>
                          </label>
                        </div>
                      </li>
                      ...
                      <li class="list-item" v-for="functional in allStates" :key="functional.id">
                        <div class="my-checkbox">
                          <label class="checkbox-inline">
                            ...
                            {{ functional.subcategory_name }}<small>({{ functional.jobmanagers.length }})</small>
                          </label>
                        </div>
                      </li>
                      ...
                      <li class="list-item" v-for="jobtype in allDesignation" :key="jobtype.id">
                        <div class="my-checkbox">
                          <label class="checkbox-inline">
                            ...
                            {{ jobtype.job_type }}<small>({{ jobtype.job_managers.length }})</small>
                          </label>
                        </div>
                      </li>
                      ...
                      <li class="list-item" v-for="qualification in allRecruiter" :key="qualification.id">
                        <div class="my-checkbox">
                          <label class="checkbox-inline">
                            ...
                            {{ qualification.qualification }}<small>({{ qualification.jobmanagers.length }})</small>
                          </label>
                        </div>
                      </li>
              ...
              <div class="list-item-box hotel-item vacation-item" v-for="joblist in allIndustry" :key="joblist.id">
                <div class="list-item row mx-0">
                    ...
                    <div class="item-description">
                      ...
                      <div class="duration fs-13">
                        ...
                        <p><i class="fa fa-pencil-alt mr-2 orange" aria-hidden="true"></i>Skills:
                          <span>
                                                        <span class="tag-item">Excellent Communication Skills</span>
                                                        <span class="tag-item">Good Presentation Skills</span>
                                                        <span class="tag-item">Angular Js</span>
                  ...
                  <div class="list-price col-sm-3 light-gray1">
                    <div class="mt-5">
                      <a href="#" class="btn btn-primary border-orange text-white btn-block"
                         @click.prevent="jobAlreadyApply()" v-if="jobsID.includes(joblist.id) == true" disabled>Already
                        Applied</a>
                      <a href="#" data-toggle="modal" :data-id="joblist.id" data-target=".mdupdate"
                         @click="openmd(joblist.id)" class="btn btn-primary border-orange text-white btn-block"
                         v-else="">Job Apply</a>
                  ...
                  <div class="col-sm-12">
                    ...
                    <div class="form-group">
                      <div class="icheck-primary d-inline">
                        <input type="radio" id="radioPrimary1" name="q1">
                        <label for="radioPrimary1">
                          Yes
                        </label>
                      </div>
                      <div class="icheck-primary d-inline">
                        <input type="radio" id="radioPrimary2" name="q2">
              ...
              <fieldset class="pl-2 pr-2 mb-3">
                ...
                <div class="form-group row mb-0">
                  <div class="col-sm-12">
                    ...
                    <div class="form-group">
                      <div class="icheck-primary d-inline">
                        <input type="radio" id="radioPrimary1" name="ex1">
                        <label for="radioPrimary1">
                          Yes
                        </label>
                      </div>
                      <div class="icheck-primary d-inline">
                        <input type="radio" id="radioPrimary2" name="ex2">
                        <label for="radioPrimary2">
                          No
                        </label>
                      </div>
              ...
              <fieldset class="pl-2 pr-2 mb-3">
                ...
                <div class="form-group row mb-0">
                  <div class="col-sm-12">
                    ...
                    <div class="form-group">
                      <div class="icheck-primary d-inline">
                        <input type="radio" id="radioPrimary1" name="sk1">
                        <label for="radioPrimary1">
                          Yes
                        </label>
                      </div>
                      <div class="icheck-primary d-inline">
                        <input type="radio" id="radioPrimary2" name="sk2">
                        <label for="radioPrimary2">
                          No
                        </label>
                      </div>
...
export default {
  ...
  mounted() {
    this.$store.dispatch('getAllData', '/guestget-industries')
    this.$store.dispatch('getAllState', '/guestget-functional-role')
    // this.$store.dispatch('getAllJobtype','/get-joblist')
    this.$store.dispatch('getAllRecruiter', '/guestget-qualification')
    this.$store.dispatch('getAllDesignation', '/guestget-job-type')
  ...
  methods: {
    ...
    getAllJobs() {
      this.loading = true;
      axios.get('guestget-joblist').then(response => {
        this.loading = false;
