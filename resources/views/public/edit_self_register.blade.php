...
<head>
  ...
  <title>Update Details on Naukriyan.com</title>
  <!-- CSS only -->
          ...
          <div class="row ">
            ...
            <div class="home-tab">
                ...
                <div class="container col-sm-12">
                    ...
                    <h3 class="text-center mt-5" >Update Candidate Registration</h3><br>
                    <form action="{{ route('update_candidate_self_registration') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <input type="hidden" name="id" value="{{ $self_data[0]->id }}">
                        <input type="hidden" name="self_code" value="{{ $self_data[0]->self_code }}">
                        <input type="hidden" name="resume" value="{{ $self_data[0]->resume }}">
                        <div class="row mx-3 ">  
                        ...
                        <span style="font-size: 14px;font-weight: 600;color: #ee1201;">* Mandatory(required) Fields</span>
                            <div class="col-md-4">
                                ...
                                <input name ="name" type="text" class="form-control" placeholder="Enter Name" value="{{ $self_data[0]->name }}" required >
                            </div>
                            <div class="col-md-4">
                              <label for="" class="m-2 fw-bold">Email <span style="font-size: 14px;font-weight: 600;color: #ee1201;">*</span></label><br>
                              <input type="email" class="form-control" name="email" id="" placeholder="Enter Email" value="{{ $self_data[0]->email }}" required>
                            </div>  
                            <div class="col-md-4">
                              <label for="" class="m-2 fw-bold">Contact</label><br>
                              <input type="text" class="form-control number_validation" maxlength="10" name="contact" id="" placeholder="Enter Contact" value="{{ $self_data[0]->contact }}" >
                            </div> 
                        ...
                        <div class="row">  
                          <div class="col-md-4">
                            ...
                            <select id="" name="gender" class="form-control" style="background-color:white;" required>
                                ...
                                <option value="male" {{ $self_data[0]->gender == "male" ? 'selected' : '' }}>Male</option>
                                <option value="female" {{ $self_data[0]->gender == "female" ? 'selected' : '' }}>Female</option>
                                <option value="others" {{ $self_data[0]->gender == "others" ? 'selected' : '' }}>Others</option>
                            </select>  
                          </div>  
                          <div class="col-md-4">
                            <label for="" class="m-2 fw-bold">Category <span style="font-size: 14px;font-weight: 600;color: #ee1201;">*</span></span></label><br>
                              <select name="category" id="category" class="form-control" style="background-color:white;" required>
                                  ...
                                  <option value="Drone Pilot" {{ $self_data[0]->category == "Drone Pilot" ? 'selected' : '' }}>Drone Pilot</option>
                                  <option value="Skill Development" {{ $self_data[0]->category == "Skill Development" ? 'selected' : '' }}>Skill Development</option>
                              </select>    
                          </div> 
                          <div class="col-md-4">
                              ...
                              <select name="qualification" id="qualification" class="form-control" style="background-color:white;" required>
                                  <option value="">Select Qualification</option>
                                    @foreach ($qualifications as $qual)
                                      <option value="{{ $qual->qualification }}" {{ $self_data[0]->qualification == $qual->qualification ? 'selected' : '' }}>{{ $qual->qualification }}</option>
                                    @endforeach 
                              </select>    
                          </div>   
                        </div>
                        <div class="row">  
                          <div class="col-md-4">
                            <label for="" class="m-2 fw-bold">Resume
                            </label>
                            @if(!empty($self_data[0]->resume))
                              <a href="{{url('self_register/'.$self_data[0]->resume)}}" target="_blank" class="btn btn-sm btn-primary" style="padding: 2px 16px!important;">View document</a>
                            @else
                          ...
                          <div class="col-md-4">
                            ...
                            <select name="state" id="state_id" class="form-control"
                                ...
                                @foreach ($state as $state)
                                    <option value="{{ $state->id }}" {{ $self_data[0]->state == $state->id ? 'selected' : '' }}>{{ $state->states_name }}</option>
                                @endforeach 
                            </select> 
                          </div> 
                          <div class="col-md-4">
                        ...
                        <div class="row">
                          <div class="col-md-4">
                            ...
                            <input type="text" class="form-control" name="city" id="" placeholder="Enter City" value="{{ $self_data[0]->city }}">
                          </div>   
                          <div class="col-md-4">
                            <label for="" class="m-2 fw-bold">Pincode</label><br>
                            <input type="text" class="form-control number_validation" maxlength="6" name="pincode" id="" placeholder="Enter Pincode" value="{{ $self_data[0]->pincode }}" >
                          </div> 
                          <div class="col-md-8">
                            <label for="" class="m-2 fw-bold">Address</label><br>
                            <textarea name="address" class="form-control" placeholder="Enter complete address here">{{ $self_data[0]->address }}</textarea>
                          </div>
