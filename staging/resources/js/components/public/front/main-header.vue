          ...
          >
            <ul class="nav navbar-nav ml-3 mr-3">
              ...
              >
               ...
               <router-link v-for="(metro,index) in topcities" :key="index" :to ="{path :'/browsejob',
               query: {
              ...
              > -->
              <li class="nav-item" role="presentation">
                  <a class="nav-link" href="http://blog.naukriyan.com/" target="_blank">Blog</a>
                </li>
              ...
              >
                ...
                <li class="dropdown-submenu">
                  ...
                  <ul class="dropdown-menu">
                    ...
                    >
                    <a class="dropdown-item" href="#">Content of Video Resume</a>
                  </ul>
                </li>
                 <li><a class="dropdown-item" href="#">How to make Effective Resume</a></li>
