...
<template>
  <div id="userinfo">
    ...
    <section class="section pb-5 top-adjust pt-0 mt-0">
          ...
          <div class="col-sm-3">
            <div class="card profile-card layout-fixed" id="profile-widget">
              ...
              <div class="card-body pt-0">
                <ul class="collection">
                  <li class="collection-item" id="pe" @click="changeTabmode('pe')" :class="tabValue === 'pe' ? 'tab-active' : ''">
                    <router-link :to="`/userinfo/pe`">
                    <span class="text">Personal / Resume</span>
                    <i class="fas fa-user-lock quick-i"></i>
                    </router-link>
                  </li>
                  <li class="collection-item" id="ed" @click="changeTabmode('ed')" :class="tabValue === 'ed' ? 'tab-active' : ''">
                    <router-link :to="`/userinfo/ed`">
                    <span class="text">Educational / Certificates / Skills</span
                    ><i class="fas fa-graduation-cap quick-i"></i>
                    </router-link>
                  </li>
                  <li class="collection-item" id="pr" @click="changeTabmode('pr')" v-if="form.candidate_type=='experienced'" :class="tabValue === 'pr' ? 'tab-active' : ''">
                ...
                <!-- candidate resume-->
            <div class="resume-card mt-3" v-if="form.resume">
             <center><h4>Resume </h4></center> 
              <div class="candidate-resume">
                <p>-  Uploaded on {{getHumanDate(form.resume_upload_date)}} </p>
                <a :href="'resume/' + form.resume" target="_blank" v-if="form.resume"><button class="btn btn-primary">Download resume <i class="fas fa-download"></i></button></a>
              </div>
            </div>
            <!--youtube resume-->
            <div class="video-resume mt-4" v-if="form.resume_video_link">
              <center><h4>Video resume </h4></center> 
                <video-embed css="embed-responsive-4by3" :src="`${form.resume_video_link}`"></video-embed>
            </div>
        
          </div>
          
          <div class="col-sm-9">
            <div class="card profile-card" id="Personal" :class="tabValue === 'pe' ? 'show-form' : 'hide-form'">
              ...
              <div class="card-body pt-0">
                ...
                >
                  ...
                  <div class="form-group input-group row">
                    <div class="col-sm-6">
                      <label class="col-form-label"
                        >Your Prefered Location<span style="color: red"> * </span></label
                      >
                      <div class="input-group-prepend">
                        <span class="input-group-text"
                          ><i class="fas fa-location-arrow"></i
                        ></span>
                        <select class="form-control" v-model="form.preferred_location">
                       ...
                       <has-error :form="form" field="preferred_location"></has-error>
                    </div>
                   <div class="col-sm-6">
                      <label class="col-form-label">I am a <span style="color: red"> * </span></label>
                  ...
                  <div class="form-group input-group row">
                    ...
                    <div class="col-sm-12">
                      <input
                            ...
                            accept="image/*"
                          />
                          <label class="custom-file-label" for="customFile">Choose Image(Only jpg/jpeg/png)</label>
                  ...
                  <div class="form-group input-group row">
                    ...
                    <div class="col-sm-12">
                      <input
                            type="file"
                            @change="changeResume($event)"
                           class="custom-file-input"
                            name="upload_resume"
                          /> 
                          <label class="custom-file-label" for="customFile">Choose Pdf file Only</label>
                  ...
                  <div class="form-group">
                    <button type="submit" class="btn btn-primary btn-block" :disabled="uploadstatus">
     ...
     <div class="card profile-card" id="Educational" :class="tabValue === 'ed' ? 'show-form' : 'hide-form'">
              <!-- for tabs start -->
          <div class="card-header">
                <h4>Multiple Stages Are Below</h4>
                  <div id="tabs" class="container">
                    ...
                    <div class="tabs text-center mt-3">
                        <a v-on:click="activetab=1" v-bind:class="[ activetab === 1 ? 'active' : '' ]">Education</a>
                        <a v-on:click="activetab=2" v-bind:class="[ activetab === 2 ? 'active' : '' ]">Skills</a>
                        <a v-on:click="activetab=3" v-bind:class="[ activetab === 3 ? 'active' : '' ]">Certificates</a>
                    </div>
                    ...
                    <div class="content">
                        <div v-if="activetab === 1" class="tabcontent">
                            ...
                            <div class="card-header">
                              <h4>Educational Information<span class="text-muted"
                                  >(You Can add multiple educational information here).</span
                                ></h4>
                            ...
                            <div class="card-header">
                              <table class="table table-bordered">
                                ...
                                <tbody>
                                  <tr
                                    v-for="(educationalDetail, index) in educationalDetails"
                                  ...
                                  >
                                    ...
                                    <td>
                                      <a
                                        ...
                                        @click.prevent="
                                          deleteEducationalDetail(educationalDetail.id)
                                        "
                            ...
                            <div class="card-body pt-0">
                              ...
                              >
                                <div class="form-group input-group row">
                                  ...
                                  <div class="col-sm-6">
                                    <label class="col-form-label">Degree/Stream Name</label>
                                    <div class="input-group-prepend">
                                      <span class="input-group-text"
                                        ><i class="fas fa-graduation-cap"></i
                                      ></span>
                                ...
                                <div class="form-group input-group row">
                                  ...
                                  <div class="col-sm-6">
                                    <label class="col-form-label">Institute Location</label>
                                    <div class="input-group-prepend">
                                      <span class="input-group-text"
                                        ><i class="fas fa-calendar"></i
                                      ></span>
            ...
            <div class="card-body pt-0">
                      ...
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          ...
                          <div class="col-md-12">
                            ...
                            <div class="form-group">
                              <label for="expert">Your Expert Level</label>
                              <div class="input-group-prepend">
                                <span class="input-group-text"
                                ...
                                <select
                                  class="form-control"
                                  name="skill_level"
                                  v-model="editSkillInformation.expert_level"
                                >
              ...
              <div class="card-header">
                <table class="table table-bordered">
                  ...
                  <tbody>
                    <tr v-for="(certInfo, index) in certInfos">
                      <td>{{ index + 1 }}</td>
                      <td>{{ certInfo.course | capitalize }}</td>
                      <td>
                        {{ certInfo.certificate_institute_name | capitalize }}
                      </td>
                      <td>
                        {{ certInfo.cert_from_date }} ||
                        {{ certInfo.cert_to_date }}
                      </td>
                      <td>{{ certInfo.certification_type | capitalize }}</td>
                      <td>
                        <a
                          href="javascript.void(0)"
                          @click.prevent="deleteCertificate(certInfo.id)"
                          class="badge badge-danger skill-del-btn"
                          >Delete</a
                        >
                        <a
                    ...
                    <div class="modal-content">
                              ...
                              <div class="col-sm-6">
                                ...
                                <div class="input-group-prepend">
                                  ...
                                  <select
                                    ...
                                    v-model="editCertInfo.certification_type"
                                  >
                              ...
                              <div class="col-sm-6">
                                ...
                                <div class="input-group-prepend">
                                  ...
                                  <input
                                    type="date"
                                    name="cert_from_date"
                                    v-model="editCertInfo.cert_from_date"
                                    class="form-control datepicker"
                                    placeholder="From"
                                  />
                                </div>
                      ...
                      <div class="modal-footer">
                        ...
                        <button
                          type="button"
                          class="btn btn-primary"
                          @click.prevent="updateCertInfo(editCertInfo.id)"
                        >
                          Save changes
                        </button>
                      </div>
              ...
              <div class="card-body pt-0">
                ...
                >
                  ...
                  <div class="form-group input-group row">
                    <div class="col-sm-6">
                      <label class="col-form-label">Certification Type</label>
                      <div class="input-group-prepend">
                        <span class="input-group-text"
                          ><i class="fas fa-user"></i
                        ></span>
  ...
  <h4 class ="ml-5">Multiple Stages Are Below</h4>
              <div class="tabs">
                  <a v-on:click="activetab=1" v-bind:class="[ activetab === 1 ? 'active' : '' ]">Professional Tab</a>
                  <a v-on:click="activetab=2" v-bind:class="[ activetab === 2 ? 'active' : '' ]">Others</a>
              ...
              <div class="content">
                ...
                <h4>
                  ...
                  <span class="text-muted"
                    >(You Can add Multiple Professional experience here).</span
                  >
                </h4>
              </div>
              <div class="card-header">
                <table class="table table-bordered">
                  ...
                  <tbody>
                    <tr
                      v-for="(professionalDetail, index) in professionalDetails"
                    ...
                    >
                      ...
                      <td>
                        <a
                          href="javascript.void(0)"
                          @click.prevent="
                            deleteProfessionalDetail(professionalDetail.id)
                          "
                          class="badge badge-danger skill-del-btn"
                          >Delete</a
                        >
                  ...
                  <form action="" method="post">
                    <div class="modal-content">
                      <div class="modal-header">
                        ...
                        <p class="modal-title">Edit Professional Detail</p>
                      </div>
                      <div class="modal-body">
                        <div class="col-md-12" v-if="errors">
                          <p class="alert alert-danger">{{ errors }}</p>
                            ...
                            <div class="col-sm-6">
                              ...
                              <div class="input-group-prepend">
                                ...
                                <select
                                  ...
                                  v-model="professionalForm.functional_role"
                                >
                                  <option value="" disabled="">
                                    Functional area
                                  </option>
                            ...
                            <div class="col-sm-12">
                              ...
                              <div class="input-group-prepend">
                                ...
                                <textarea
                                  type="text"
                                  name="responsibility"
                                  v-model="professionalForm.responsibility"
                                  class="form-control"
                    ...
                    <div class="col-sm-6">
                      ...
                      <div class="input-group-prepend">
                        ...
                        >
                          ...
                          <option :value="jt.id" v-for="jt in allJobtype">
                            {{ jt.job_type }}
                          </option>
                        </select>
                      </div>
                    ...
                    <div class="col-sm-6">
                      ...
                      <div class="input-group-prepend">
                        ...
                        >
                          ...
                          <option :value="js.id" v-for="js in allJobshift">
                            {{ js.job_shift }}
                          </option>
                        </select>
                      </div>
                    ...
                    <div class="col-sm-6">
                      ...
                      <div class="input-group-prepend">
                        ...
                        >
                          ...
                          <option :value="ind.id" v-for="ind in allIndustry">
                            {{ ind.category_name }}
                          </option>
                        </select>
                      </div>
                    ...
                    <div class="col-sm-6">
                      ...
                      <div class="input-group-prepend">
                        ...
                        >
                          ...
                          <option :value="fr.id" v-for="fr in allDesignation">
                            {{ fr.subcategory_name }}
                          </option>
                        </select>
                      </div>
                        ...
                        <div class="row">
                          <div class="col-sm-6">
                            ...
                            >
                              ...
                              <option :value="index" v-for="(num, index) in 25">
                                {{ index }} Yr
                              </option>
                            </select>
                          </div>
                          <div class="col-sm-6">
                            ...
                            >
                              <option disabled="disabled">Select Months</option>
                              <option :value="index" v-for="(num, index) in 12">
                                {{ index }} Month
                              </option>
                            </select>
                          </div>
                    ...
                    <div class="col-sm-6">
                      ...
                      <div class="input-group-prepend">
                        <span class="input-group-text"
                          ><i class="fas fa-location-arrow"></i
                        ></span>
                        <select class="form-control" v-model="form.current_working_location">
                    ...
                    <div class="col-sm-6">
                      ...
                      <div class="input-group-prepend">
                        ...
                        >
                          ...
                          <option
                            value="voter_id"
                            :selected="form.other_id_type === 'voter_id'"
                          >
                            VOTER ID
                          </option>
                          <option
                          ...
                          <option
                            value="passport_no"
                            :selected="form.other_id_type === 'passport_no'"
                          >
                            PASSPORT NO.
                          </option>
                        </select>
                  ...
                  <div class="form-group input-group row">
                    ...
                    <div class="col-sm-6">
                      ...
                      <div class="input-group-prepend">
                        ...
                        >
                          <option value="" disabled="">Functional area</option>
                          <option :value="fr.id" v-for="fr in allDesignation">
                            {{ fr.subcategory_name }}
                          </option>
                        </select>
  ...
  data() {
    return {
      ...
      form: new Form({
        ...
        other_id_type: "",
        id_number: "",
        profile_pic_thumb: "",//in table field
        pic:"", //upload time
