          ...
          <div class="col-sm-8">
            ...
            <div class="required">
               <div class="form-group">
                          ...
                          <input class="form-control" v-model="form.skill" type="text" placeholder="Enter Skills,position(optional) you are working for">
                        </div>
            </div>
            <div class="panel-group mt-3" id="accordion">
                  ...
                  <div class="panel-body">
                    <div class="row">
                      <div class="col-md-6">
                          ...
                          <input class="form-control" type="text" v-model="form.optional_keywords" placeholder="Optional first name,last name,email,contact,designation role seperated by comma">
                        </div>
                          <label for="exampleFormControlSelect1">Experience</label>
                          <div class="row">
                            <div class="col-5">
                              <div class="form-group">
                                <select class="form-control custom-select" v-model="form.min_exp">
                              <option value="">Min</option>
                              <option v-for="exp in experiences"
                              :value="exp" :key="exp"
                            >
                              {{ exp }}
                            </option>
                            ...
                            <div class="col-5">
                              <div class="form-group">
                                <select class="form-control custom-select" v-model="form.max_exp">
                          ...
                          <div class="form-group">
                            <label for="exampleFormControlSelect1">Location</label>
                                <select class="form-control custom-select"  v-model="form.current_location">
                                  <optgroup :label="st.state" v-for="st in location" :key="st.id">
                                    <option v-for="loc in st.location" :key="loc.id" :value="loc.location">{{loc.location}}</option>
                                  </optgroup>
                            </select>
                          </div>
                      </div>
                      ...
                      <div class="col-md-6">
                          ...
                          <input class="form-control" type="text" v-model="form.mandate_keywords" placeholder="Mandatory first name,last name,email,contact,designation role seperated by comma">
                        </div>
                          <label for="exampleFormControlSelect1">Salary</label>
                          <div class="row">
                            <div class="col-5">
                              <div class="form-group">
                                <input class="form-control" placeholder="From" v-model="form.from_salary">
                              </div>
                            </div>
                            <div class="col-2">
                              <b>To</b>
                            ...
                            <div class="col-5">
                              <div class="form-group">
                                <input class="form-control" placeholder="To" v-model="form.to_salary">
                              </div>
                            </div>
                          </div>
                          <div class="form-group">
                          <label for="">Excluding Keywords</label>
                          <input class="form-control" type="text" v-model="form.excluding_keywords" placeholder="first name,last name,email,contact,Designation role seperated by comma">
                        </div>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <select class="form-control custom-select" v-model="form.functionalrole">
                            <option value="">Select Functional Area</option>
                            <option v-for="functional in functionalinfo" :value="functional.id" :key="functional.id">{{functional.subcategory_name}}</option>
                          </select>
                        </div>
                      </div>
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <select class="form-control custom-select" v-model="form.industry">
                            <option value="">Select Industry</option>
                            <option v-for="industry in industryinfo" :value="industry.id" :key="industry.id">{{industry.category_name}}</option>
                          </select>
                        </div>
                      </div>
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" @focus="filterStatus = true" v-model="company_name" placeholder="Type or select companies name">
                          <div style="background-color: white">
                              <ul
                                class="filter-keyword"
                                v-if="filteredKeywords && filterStatus && company_name!==''"
                              >
                              <li
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input class="form-control" type="text" v-model="form.designation" placeholder="Designation">
                        </div>
                      </div>
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" @focus="filterStatusEx = true" v-model="exclude_company_name" placeholder="Type or select companies name">
                         <div style="background-color: white">
                              <ul
                                class="filter-keyword"
                                v-if="filteredKeywordsEx && filterStatusEx && exclude_company_name!==''"
                              >
                              <li
                                v-for="(filterKeywordEx, index) in filteredKeywordsEx.slice(
                                  0,
                                  9
                                )"
                                :key="index"
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <select class="form-control custom-select" v-model="form.notice_period">
                  ...
                  <div class="panel-body">
                    <div class="">
                      <ul class="nav nav-tabs" role="tablist">
                            <li class="nav-item">
                              <a class="nav-link active" href="#profile" role="tab" data-toggle="tab">Qualification</a>
                            </li>
                            <!-- <li class="nav-item">
                          ...
                          <div class="tab-content mt-3">
                            <div role="tabpanel" class="tab-pane fade in active show" id="profile">
                                ...
                                <div class="form-group">
                                  <label for="">Qualification</label>
                                  <select class="form-control custom-select" v-model="form.ug_qualification_name">
                                    <optgroup :label="grp.group" v-for="grp in allQual" :key="grp.id">
                                      <option v-for="qual in grp.qualification" :key="qual.id" :value="qual.id">{{qual.qualification}}</option>
                                  </optgroup>
                                  </select>
                                </div>
                                <div class="form-group">
                                  <label for="">Institute Name</label>
                                  <input class="form-control" type="text" @focus="filterStatusInstitute=true" v-model="ug_institute_name" placeholder="Name of Institute">
                                  <div style="background-color: white">
                                      <ul
                                        class="filter-keyword"
                                        v-if="filteredKeywordsInstitute && filterStatusInstitute && ug_institute_name!==''"
                                      >
                                        <li
                                          v-for="(filterKeywordInstitute, index) in filteredKeywordsInstitute.slice(
                                            0,
                                            9
                                          )"
                                          :key="index"
                                ...
                                <div class="form-group">
                                  ...
                                  <select class="form-control custom-select" v-model="form.ug_education_type">
                                ...
                                <div class="row">
                                  ...
                                  <select class="form-control custom-select" v-model="form.start_graduation">
                                  ...
                                  <div class="col-sm-4">
                                     <div class="form-group">
                                  <select class="form-control custom-select" v-model="form.to_graduation">
                ...
                <div id="collapseFour" class="panel-collapse collapse">
                  <div class="panel-body">
                              ...
                              <div class="form-group">
                               ...
                               <label for="exampleFormControlSelect1">Candidate Age(In years)</label>
                                <div class="row">
                                  <div class="col-sm-2">
                                    <center><b>From</b></center> 
                                  </div>
                                  <div class="col-sm-4">
                                     <div class="form-group">
                                  <input type="text" class="form-control" v-model="form.min_age">
                                  ...
                                  <input type="text" class="form-control" v-model="form.max_age">
                ...
                <div id="collapseFive" class="panel-collapse collapse">
                  <div class="panel-body">
                       ...
                       <div class="form-group">
                                ...
                                <label class="checkbox-inline"><input type="checkbox" id="new" value="new" v-model="checkednew"> New Registrations</label>
                                <label class="checkbox-inline"><input type="checkbox" id="modified" value="modified" v-model="checkedmodified"> Modified Candiates</label> 
                              </div>
                       <div class="form-group">
                              ...
                              <div class="row">
                                ...
                                <div class="col-sm-2">
                                  <div class="form-group">
                                    <select class="form-control custom-select" v-model="form.resume_per_page">
                                      <option value="">Select Here</option>
              ...
              <div class="submit-search card-footer border-light cart-panel-foo-fix">
                 <div class="row">
                   <div class="col-sm-6">
                     <div class="row">
                       <div class="col-sm-3"><label for="exampleFormControlSelect1" style="line-height:2;">Active in</label></div>
                       <div class="col-sm-4"><select class="custom-select" v-model="form.active_in">
               ...
               <router-link :to ="{path :'/resumeview',
               query: {
      ...
      <div v-if="!savesearchurl" class="text-center">
        <h4>Loading...</h4>
			...
			<div class="list-group list-group-flush" v-else>
			  <a class="list-group-item" v-for="(saveurl, index) in savesearchurl" :key="saveurl.id" :href="saveurl.url">{{index+1}}.{{saveurl.search_name}} <span class="float-right badge badge-light round">{{getHumanDate(saveurl.created_at) }}</span> </a>    
			</div>  <!-- list-group .// -->
		</div>
