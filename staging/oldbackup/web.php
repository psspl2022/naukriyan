...
Route::group(['middleware' => 'employer'], function () {
    ...
    Route::post('/add-resume-tag/{tag}/{candidate}', 'viewresumeController@add_resume_tag');
    Route::post('/add-new-tag/{tag}', 'viewresumeController@add_new_tag');
...
Route::group(['middleware' => ['auth:admin']], function () {
    ...
    Route::get('/employer-filter/{industry_id?}/{company_id?}/{email?}/{status?}', 'AllUsersController@filter');
    ...
    Route::get('/jobseeker-filter/{industry_id?}/{company_id?}/{email?}/{status?}', 'JobseekerController@filterJobseeker');
