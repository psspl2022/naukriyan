                    ...
                    <div class="row"  >
                        <div class="col-sm-3"v-for="packjs in alldata" :key="packjs.id" >
                            <div class="plan">
                                ...
                                <a class="signup" href="" @click.prevent="PackageAlreadyBuy()" v-if="jobsID.includes(packjs.id) == true" disabled>Already Purchase</a>
                              <router-link :to="`/buy-package-jobseeker/${packjs.id}`"v-else="" > <a class="signup" href="">Purchase</a></router-link>  
                                <ul>
...
<script>
    export default {
        ...
        mounted(){
          this.$store.dispatch('getAllData','/get-jobseeker-package')
        },
        computed:{
         alldata(){
        ...
        methods: {
            ...
            checkUserBuyPackage() {
                const self = this;
                axios.get('/check-user-buy-package-jobseeker').then(response => {
            ...
            PackageAlreadyBuy() {
                // 
                swal("Already Purchased!", "You clicked the button!", "success")
            },
