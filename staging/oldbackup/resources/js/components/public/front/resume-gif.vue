<template>
  <div id="main-header">
    <div id="wrapper">
      ...
      <button type="button" class="btn my-example-model resume-gif" data-toggle="modal" data-target="#fullHeightModalRight">
        <!--       <img src="default_images/resume.gif" alt="upload resume">-->
        <div class="alert alert-warning ml-auto" role="alert" style="width: 50%;box-shadow:rgb(74 74 74 / 75%) 2px 2px 20px;">
          <h4 class="alert-heading">Upload your resume now!</h4>
          <p>Upload your latest resume so that you can see the opportunities for you.</p>
          <hr>
          <button class="btn btn-primary"><i class="fas fa-file-upload"></i> &nbsp; Upload now</button>
        </div>
      </button>
