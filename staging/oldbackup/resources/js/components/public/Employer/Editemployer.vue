                    ...
                    >
                      <fieldset>
                        ...
                        <div class="form-group row mb-2">
                          ...
                          <div class="col-sm-4">
                            <label class="col-form-label" for=""
                              >Company Tagline<span style="color: red"
                                >*</span
                              ></label
                            >
                            <input
                        ...
                        <!-- view Image -->
                        <div class="form-group row mb-2">
                          <div class="col-sm-4" v-if="form.company_logo">
                            <label>Your Logo </label>
                               <img :src="'/company_logo/' + form.company_logo" alt="No Image" width="200" height="100" > 

                          </div>

                          <div class="col-sm-4" v-if="form.cover_image">
                            <label>Your Banner</label>
                               <img :src="'/company_cover/' + form.cover_image" alt="No Image" width="200" height="100" >
                          </div>
                          </div>
                      ...
                      <fieldset class="mt-3">
                        ...
                        <div class="form-group row mb-2">
                          ...
                          <div class="col-sm-4">
                            <label class="col-form-label" for="">
                              Revenue<span style="color: red">*</span></label
                            >
                            <input
                              type="text"
                              class="form-control"
                          ...
                          <div class="col-sm-4">
                            <label class="col-form-label" for="">
                              Corporate Identification Number/License Number<span style="color: red"
                                >*</span
                              ></label
                            >
                            <input
                      ...
                      <fieldset class="mt-3">
                        ...
                        <div class="form-group row mb-2">
                          <div class="col-sm-4">
                            <label class="col-form-label" for="">
                              Facebook<span style="color: red">*</span></label
                            >
                            <input
                              type="text"
                              class="form-control"
                          ...
                          <div class="col-sm-4">
                            <label class="col-form-label" for=""
                              >Twitter<span style="color: red">*</span></label
                            >
                            <input
                              type="text"
                              class="form-control"
                      ...
                      <fieldset class="mt-3">
                        ...
                        <div class="form-group row mb-2">
                          <div class="col-sm-12">
                            <label class="col-form-label" for="">
                              About Company<span style="color: red"
                                >*</span
                              ></label
                            >
                            <textarea
                      ...
                      <fieldset class="mt-3">
                        ...
                        <div class="form-group row mb-2">
                          <div class="col-sm-12">
                            <label class="col-form-label" for=""
                              >Video link<sub> (Space not allowed)</sub
                              ><span style="color: red">*</span></label
                            >
                            <input
                              type="text"
  ...
  methods: {
    ...
    changeProfile(event) {
      ...
      if (file.size > 1048576) {
        ...
        reader.onload = (event) => {
          this.form.profile = event.target.result;
        };
