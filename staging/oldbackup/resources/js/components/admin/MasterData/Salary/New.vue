                        ...
                        <form role="form" @submit.prevent="Salary()">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                  ...
                                  <input type="number" class="form-control" id="salary" @change="updatesal" placeholder="Add Salary in per month" v-model="form.salary" name="salary" :class="{ 'is-invalid': form.errors.has('salary') }" min="0">
                                    <has-error :form="form" field="salary"></has-error>
                                </div>

                                <div class="form-group">
                                  <label for="salary_in_annum">Salary in per Annum (Auto Calculate)</label>
                                  <input type="number" class="form-control" id="salary_in_annum" @change="updatesalmon" value="form.salary_in_annum" placeholder="Add Salary in Annum" v-model="form.salary_in_annum" name="salary_in_annum" :class="{ 'is-invalid': form.errors.has('salary_in_annum') }" min="0">
