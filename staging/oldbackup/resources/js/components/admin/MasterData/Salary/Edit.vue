                        ...
                        <form role="form" @submit.prevent="updatesalary()">
                            <div class="card-body">
                                <div class="form-group">
                                  ...
                                  <input type="number" class="form-control" id="salary"  @change="updatesal" placeholder="Add salary Name" v-model="form.salary" name="salary" :class="{ 'is-invalid': form.errors.has('salary') }" min="0" required="">
